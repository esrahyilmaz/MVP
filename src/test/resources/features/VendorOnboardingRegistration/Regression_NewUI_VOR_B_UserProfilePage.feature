Feature: Regression NewUI Vendor Onboarding Registration - User Profile Page 

#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^User Profile^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
@VendorOnboarding
@301Regression 
@UserProfilePage
Scenario: NewUIVendorRegistration_SC01-VendorRegistration-NewUI User Profile Page 
	Given I initialize Browser 
	And I am executing "NewUIVendorRegistration_SC01-VendorRegistration-NewUI User Profile Page" 
...
#******************Validation of Error Message at User Profile Page*******************************************
@VendorOnboardingErrorMessages
@errorMessageReg 
@ErrorMessagesValidationOnUserProfilePage
Scenario: NewUIVendorRegistration_SC01-VendorRegistration-NewUI User Profile Page Invalid 
	Given I initialize Browser 
	And I am executing "NewUIVendorRegistration_SC01-VendorRegistration-NewUI User Profile Page Invalid" 
	And I navigate to "NewUI Vendor Registration" application 
	And I should see "text" named as "Have you signed up?" on "login page" Page 
	And I click on "signupbutton" "Sign up" on "login page" Page 
