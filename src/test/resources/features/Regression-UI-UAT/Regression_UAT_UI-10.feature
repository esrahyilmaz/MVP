Feature: Regression NewUI UI-10

#First run Regression_UAT_Prerequisites.feature --> @UI-10-property-UAT     
#*****************************************************************************************************************************************

######################NewUI UI-10######################     
@UI-10 @NewUI-10-VendorOnboarding-UAT
Scenario: NewUIRegression_UI-10-VendorOnboarding
	Given I initialize Browser
	When I Execute "Validate the Vendor Onboarding Flow with Vendor Registration Cost $0" 
	And I am executing "NewUIRegression_UI-10-VendorOnboarding" 
...
############################################NewUI UI-10##################################################################     
@UI-10 @NewUI-10-VendorOnboardingLogin-UAT
Scenario: NewUIRegression_UI-10-VendorOnboardingLogin
	Given I initialize Browser
	When I Execute "Validate the Vendor Onboarding Flow with Vendor Registration Cost $0" 
	And I am executing "NewUIRegression_UI-10-VendorOnboardingLogin" 
	And I navigate to "NewUI" application 
	And I should see element "login page"
...
#####################################################################################################################################
@UI-10 @NewUI-10-PAFlow-UAT-UAT
	Scenario: NewUIRegression_UI-10-PAFlow
	...
	And I am executing "NewUIRegression_UI-10-PAFlow" 
	And I navigate to "NewUI" application 
	And I should see element "login page"
   ...
   And I click on "button-newui" "Middle Name Yes" on "create person" Page
	...
	And I click on "order status screening" "hyperlink" on "People" Page
...
#####################################################################################################################################
@UI-10 @NewUI-10-Additional-BillingZero-UAT 
Scenario: NewUIRegression_UI-10-Additional-BillingZero
	Given I initialize Browser 
	When I Execute "Validate Additional Billing - Flag set to 'Y' and Price to $0"
	And I am executing "NewUIRegression_UI-10-Additional-BillingZero" 
	And I navigate to "NewUI" application 
	And I should see element "login page"
    And I should see "button-newui" named as "Login" on "Login" Page
 ...
 #####################################################################################################################################
@UI-10 @NewUI-10-Additional-BillingPrice-UAT
	Scenario: NewUIRegression_UI-10-Additional-BillingPrice

	Given I initialize Browser 
	When I Execute "Validate Additional Billing - Flag set to 'Y' and Price to $1"
	
	And I am executing "NewUIRegression_UI-10-Additional-BillingPrice" 
	And I navigate to "NewUI" application 
	And I should see element "login page"
    And I should see "button-newui" named as "Login" on "Login" Page
