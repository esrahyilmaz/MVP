Feature: Regression NewUI UI-4

#First run Regression_UAT_Prerequisites.feature --> @UI-4-property-UAT 
    
#*****************************************************************************************************************************************

######################NewUI UI-4######################     
@UI-4 @NewUI-4-VendorOnboarding-UAT
Scenario: NewUIRegression_UI-4-VendorOnboarding
	Given I initialize Browser
	When I Execute "Validate the Vendor Onboarding Flow with Vendor Registration Cost $0" 
	And I am executing "NewUIRegression_UI-4-VendorOnboarding" 
	...
	And I should see "text-newui" named as "Subtotal_VendorOnboarding" on "payment method" Page
	And Verify value "Tax" on "Vendor Registration" Page for DB "UAT"
	And I should see "text-newui" named as "Tax_VendorOnboarding" on "payment method" Page
	...
	When I should see element "6 completed sections" for "green tick mark"
...
############################################NewUI UI-4##################################################################     
@UI-4 @NewUI-4-VendorOnboardingLogin-UAT
Scenario: NewUIRegression_UI-4-VendorOnboardingLogin
	Given I initialize Browser
	When I Execute "Validate the Vendor Onboarding Flow with Vendor Registration Cost $10" 
	And I am executing "NewUIRegression_UI-4-VendorOnboardingLogin" 
	And I navigate to "NewUI" application 
	And I should see element "login page"
	...
	And I should see element "credit card vendor reg" for "payment method"
...
@UI-4 @NewUI-4-PAFlow-UAT
	...
	And I am executing "NewUIRegression_UI-4-PAFlow"
	And I navigate to "NewUI" application
	And I should see element "login page"
	...
	When I Execute "Validate PA flow with changed First, Last and Middle name"
	And I should see element "People"
    ...
    And I fill details in PA "Profile-WithChanges" page 
	...
	Then I should see Text "No Results Found"
 	...
 	Then wait Until Profile Status is "Completed" for "Changed FML in PA"
 	Then I should see element "Background Tile"
    Then I should see element "Background Tile" for "Pending"
    Then I should not see element "Compilance Status"
	Then I should see element "Status" for "Screening"
	And I should see element "Pending" for "screening accordion search"
	And I click on "order status PA" "hyperlink" on "People" Page
...
@UI-4 @NewUI-4-PAFlow-UAT
    ...
    Then I should see element "Profile ID"
	Then I should not see element "Background Tile"
	Then I should not see element "Compliance"
	Then I should see element "Status" for "Screening"
	And I should see element "Pending" for "screening accordion search"
	And I click on "order status" "no hyperlink" on "People" Page
    And I should not see element "compliance hyperlink"
...
#####################################################################################################################################
@UI-4 @NewUI-4-Additional-BillingZero-UAT  
Scenario: NewUIRegression_UI-4-Additional-BillingZero
	Given I initialize Browser 
	When I Execute "Validate Additional Billing - Flag set to 'Y' and Price to $0"
	And I am executing "NewUIRegression_UI-4-Additional-BillingZero" 
	And I navigate to "NewUI" application 
	And I should see element "login page"
    And I should see "button-newui" named as "Login" on "Login" Page
 ...
 #####################################################################################################################################
@UI-4 @NewUI-4-Additional-BillingPrice-UAT
	Scenario: NewUIRegression_UI-4-Additional-BillingPrice

	Given I initialize Browser 
	When I Execute "Validate Additional Billing - Flag set to 'Y' and Price to $1"
	
	And I am executing "NewUIRegression_UI-4-Additional-BillingPrice" 
	And I navigate to "NewUI" application 
	And I should see element "login page"
    And I should see "button-newui" named as "Login" on "Login" Page
