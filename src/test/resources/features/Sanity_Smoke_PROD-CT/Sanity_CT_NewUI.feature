Feature: Sanity_CT_NewUI

@VendorOnboardingSanityTestingCT @SanityTestingCT
Scenario: SanityCTNewUI_VendorOnboarding Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate the Vendor Onboarding Flow with Invoice - TC-ID 28659"
	
	And I am executing "SanityCTNewUI_VendorOnboarding Sanity Testing" 
...
@LoginSanityTestingCT @SanityTestingCT
Scenario: SanityCTNewUI_Login Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate Login Functional - TC-ID 28662"
	
	And I am executing "SanityCTNewUI_Login Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
	...
	When I log in to "newuictadmin" New UI application with "onlyPassword" Credentials
	And I click on "button-newui" "Login" on "Login" Page
	And I should see "errormsg-newui" named as "Username is required" on "Login" Page 

	When I log in to "newuictadmin" New UI application with "validPassword" Credentials
	And I click on "button-newui" "Login" on "Login" Page 
	And I should see "errormsg-newui" named as "We couldn't find your account." on "Login" Page
	
	And I log in to "newuictadmin" New UI application with "validUserName" Credentials
	And I click on "button-newui" "Login" on "Login" Page
	...
	When I log in to "newuictadmin" New UI application with "valid" Credentials 
	And I click on "button-newui" "Login" on "Login" Page
...
@AppErrorMsgSanityTestingCT	@SanityTestingCT
Scenario: SanityCTNewUI_Application Error Messages

	Given I initialize Browser 	

	And I am executing "SanityCTNewUI_Application Error Messages" 
...
@PeopleOrderingCompletedSanityTestingCT	@SanityTestingCT1
Scenario: SanityCTNewUI_People Ordering using PA with Invoice - Completed
	...
	And I am executing "SanityCTNewUI_People Ordering using PA with Invoice - Completed" 
	...
	And I click on "button-newui" "search" on "add people" Page
	And I click on "radiobutton-newui" "first pkg" on "Add People" Page
	And Verify value "Price" on "Package Selection" Page for DB "CT"
	...
	And Verify value "Price" on "Shopping Cart" Page for DB "CT"
	And I should see "text-newui" named as "Subtotal" on "Shopping Cart" Page
########## 	commented because there is existing bug on it  ID - 34486 #############
#	And Verify value "Tax" on "Shopping Cart" Page for DB "CT"
	...
	And Verify value "Vendor email" on "Order Confirmation" Page for DB "CT"
	...
	And I navigate to "PAInviteLanuchUrlCT" application
	...
	Then Wait until Element Present "Authorization Page"
...
@PeopleOrderingConsentRejectedSanityTestingCT @SanityTestingCT1
Scenario: SanityCTNewUI_People Ordering using PA with Invoice - Consent Rejected

	Given I initialize Browser 
	When I Execute "Validate Profile status and Background tile is functional (EMAIL SENT, REGISTRATED, CONSENT REJECTED)"
	
	And I am executing "SanityCTNewUI_People Ordering using PA with Invoice - Consent Rejected" 
...
@PeopleSearchSanityTestingCT @SanityTestingCT
Scenario: SanityCTNewUI_People Search Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate People Search using FN, LN, SSN - TC-ID 28666"
	
	And I am executing "SanityCTNewUI_People Search Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@NewOrderSanityTestingCT   @SanityTestingCT
Scenario: SanityCTNewUI_People New Order Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate New Order Action - TC-ID 28670"
	
	And I am executing "SanityCTNewUI_People New Order Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@PeopleSetStatusSanityTestingCT @SanityTestingCT
Scenario: SanityCTNewUI_People Set Status Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate Set Status Action such as Active, Inactive, Terminated - TC-ID 28671"
	
	And I am executing "SanityCTNewUI_People Set Status Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@AddNewUserSaniyTestingCT  @SanityTestingCT
Scenario: SanityCTNewUI_Add New User Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate Adding New user - TC-ID 286786"
	
	And I am executing "SanityCTNewUI_Add New User Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@EditUserSaniyTestingCT  @SanityTestingCT
Scenario: SanityCTNewUI_Edit User Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate Edit User Actions - TC-ID 28679"
	
	And I am executing "SanityCTNewUI_Edit User Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@UserSearchSanityTestingCT @SanityTestingCT
Scenario: SanityCTNewUI_User Search Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate User Search using FN, LN, Email - TC-ID 28676"
	
	And I am executing "SanityCTNewUI_User Search Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@UserStatusSanityTestingCT  @SanityTestingCT
Scenario: SanityCTNewUI_User Status Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate User Status such as Active and Inactive - TC-ID 28680"
	
	And I am executing "SanityCTNewUI_User Status Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@UpdateUserLoginSanityTestingCT    @SanityTestingCT2
Scenario: SanityCTNewUI_Update User Login Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate Update User Login - TC-ID 28684"
	
	And I am executing "SanityCTNewUI_Update User Login Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@SummaryUserLoginSanityTestingCT @SanityTestingCT2
Scenario: SanityCTNewUI_Summary User Login Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate Summary User Login - TC-ID 28685"
	
	And I am executing "SanityCTNewUI_Summary User Login Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@ViewUserLoginSanityTestingCT @SanityTestingCT2
Scenario: SanityCTNewUI_View User Login Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate View User Login - TC-ID 28686"
	
	And I am executing "SanityCTNewUI_View User Login Sanity Testing" 
	And I navigate to "SanityCTNewUI" application 
...
@PaginationSanityTestingCT   @SanityTestingCT         
Scenario: SanityCTNewUI_Pagination Sanity Testing

	Given I initialize Browser 
	When I Execute "Validate Pagination for screens - TC-ID 28717"
	
	And I am executing "SanityCTNewUI_Pagination Sanity Testing" 
	And I navigate to "SanityCTNewUI" application
