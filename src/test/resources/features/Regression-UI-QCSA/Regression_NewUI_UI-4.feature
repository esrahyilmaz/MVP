...
Scenario: NewUIRegression_UI-4-VendorOnboarding
	...
	And I should see "text-newui" named as "Subtotal_VendorOnboarding" on "Shopping Cart" Page
	And Verify value "Tax" on "Vendor Registration" Page for DB "QCSA"
	And I should see "text-newui" named as "Tax-VendorOnboarding" on "Shopping Cart" Page
...
############################################NewUI UI-4##################################################################     
@UI-4 @NewUI-4-VendorOnboardingLogin
...
#	And I search for "TestYQD SeptVMG"
...
#####################################################################################################################################
@UI-4 @NewUI-4-Additional-BillingZero  
Scenario: NewUIRegression_UI-4-Additional-BillingZero
 ...
 #####################################################################################################################################
@UI-4 @NewUI-4-Additional-BillingPrice
